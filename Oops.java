//package mypPackage; // User Define Package
import java.util.*;// Inbuid Fuction
...
public class Oops {
    public static void main(String arg[]){
        ...
        */
        ...
        // any.eat();
        // Deer d = new Deer(); // if eat not define in child class then it's gona used parent class eat function
        // d.eat();
    ...
    //   //class-> object -> take space in new memeor -> constructor with perameter System.in taking input from user
    //     int a = sc.nextInt();
    //     int b = sc.nextInt();
    //     int sum = a + b;
        
        //2. User define function
        // whatever write code in java file the just include  Package mypPackage; and the pack is created
        ...
        //chessPlayer chess = new chessPlayer(); // Error Genrate
        Queen q = new Queen();
        q.moves();
...
// Abstraction (hide data in range : 0 - 100 %)
// abstract class Animal{
//     String color;
//     Animal(){
//         color = "Brown";
//         System.out.println("Animal constractor colled..,   ");
//     }
//     void eat(){
//         System.out.println("Eat Anthing");
//     }
//     abstract void walk(); // we declare here but not define here
// }

// class Horse extends Animal {
//     void walk(){
//         System.out.println("Walk on 4 legs"); // we define here
//     }
//     void changeColor(){
//         System.out.println("");
//     }
...
//     Horse(){
//         System.out.println("Horse Constroctor");
//     }
// }
...
//     Mustang(){
//         System.out.println("Mustang Constractor colled ...");
//     }
// }

//Interface 

//1. Total abstraction :- 100 % data hiding
...
class Queen implements chessPlayer{
    public void moves(){
        System.out.println("Up, Down, Left, Right, Deigonal (in all 4 dirm)");
    }
}
...
class King implements chessPlayer{
    public void moves(){
        System.out.println("Up, Down, Left, Right, Diagnal (by 1 step)");
    }
}

//2.Implement mutiple Inheritance
...
class Beer implements Herbivore, Cornivore{
...
class Student {
    ...
    static int returnPercentages(int math, int phy, int chem){
...
class Animal{
    String color;
    Animal(){
        System.out.println("animal Constractor is colled...  ");
    }
}

class Horse extends Animal{
    Horse(){
        super(); // colled fucttion colled
        System.out.println("Horse Constractor is colled...  ");
        super.color = "Brown";
    }
}
